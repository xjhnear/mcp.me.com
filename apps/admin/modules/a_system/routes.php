...
//设置
Route::controller('a_system/setting','modules\a_system\controllers\SettingController');
//积分
...
//任务
Route::controller('a_system/task','modules\a_system\controllers\TaskController');
//通知
...
Route::controller('a_system/share','modules\a_system\controllers\ShareController');
