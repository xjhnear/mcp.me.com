...
//        print_r($result);
    ...
    public function getDelect($id)
    {
        ...
        if(empty($id)){
            return $this->redirect('v4giftbag/package/search')->with('global_tips','参数丢失');
        }
        $params['id']=$id;
        ...
        if($result['errorCode'] == 0){
            return $this->redirect('v4giftbag/package/search')->with('global_tips','操作成功');
        }else{
            return $this->redirect('v4giftbag/package/search')->with('global_tips','操作失败');
        }
    }
    ...
    public function postAdd()
    {
        ...
        if($result['errorCode']==0){
            ...
            if($result['errorCode']==0){
                return $this->redirect('v4giftbag/package/search')->with('global_tips','创建成功!');
            }
        }
...
//        print_r($input);print_r($result);die;
        if($result['errorCode']==0){
            return $this->redirect('v4giftbag/package/search-material')->with('global_tips','创建成功!');
        }
        return $this->back()->with('global_tips','入库失败！');
    }
    ...
    {
        if(empty($id)){
            return $this->redirect('v4giftbag/package/search-material')->with('global_tips','参数丢失');
        }
        $params['id']=$id;
        $params['onOrOff']='false';
        $params['isActive']='false';
        ...
        if($result['errorCode'] == 0){
            return $this->redirect('v4giftbag/package/search-material')->with('global_tips','操作成功');
        }else{
            return $this->redirect('v4giftbag/package/search-material')->with('global_tips','操作失败');
        }
    }
    ...
    public function postImport()
    {
        ...
        if($result['errorCode']==0){
            return $this->redirect('v4giftbag/package/search')->with('global_tips','导入成功');
        }else{
            return $this->back()->with('global_tips','操作失败->'.$result['errorDescription']);
        }
    }
    ...
    public function getCardStatus($goods_id,$status)
    {
        ...
        if($result['errorCode']==0){
            return $this->redirect('v4giftbag/package/search')->with('global_tips','卡密属性修改成功');
        }
        return $this->back()->with('global_tips','操作失败->'.$result['errorDescription']);
    }
...
//        print_r($result);
        if($result['errorCode'] !=null ){
            foreach($result['result'] as &$item){
                ...
                if(isset($item['virtualImgpath'])){
                    $item['virtualImgpath'] = json_decode($item['virtualImgpath'],true);
                }
            }
