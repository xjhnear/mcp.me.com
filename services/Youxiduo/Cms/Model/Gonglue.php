...
class Gonglue extends BaseModel
{
	const TABLE = 'gonglue';
	/**
	 * 保存文章
	 ...
	 */
	public static function getList($page=1,$pagesize=10,$keyword='',$t='gtitle'){
		$flag = 0;
...
// 			var_dump($v);exit;
	 ...
	 * 删除文章
	 */
	public static function delArticles($ids) {
		return self::dbCmsMaster()->table(self::TABLE)->whereIn('id', $ids)->delete();
	}
