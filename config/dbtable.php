...
$v4_tables = array(
    ...
    /*** fujiajun 2015/5/22 添加广告数据连接 ***/
    'youxiduo_adv_model_appadv'=>array('db'=>'adv','table'=>'appadv'),
    'youxiduo_adv_model_apptypes'=>array('db'=>'adv','table'=>'apptypes'),
    'youxiduo_adv_model_location'=>array('db'=>'adv','table'=>'location'),
    'youxiduo_adv_model_nature'=>array('db'=>'adv','table'=>'nature'),
    'youxiduo_adv_model_recommend'=>array('db'=>'adv','table'=>'recommend'),
    'youxiduo_adv_model_recommendedadv'=>array('db'=>'adv','table'=>'recommendedadv'),
    'youxiduo_adv_model_version'=>array('db'=>'adv','table'=>'version'),
    'youxiduo_adv_model_task'=>array('db'=>'adv','table'=>'task'),
    /******/
    
    'youxiduo_adv_model_v4appadv'=>array('db'=>'adv','table'=>'v4appadv'),
    'youxiduo_adv_model_v4appadvthird'=>array('db'=>'adv','table'=>'v4appadv_third'),
    'youxiduo_adv_model_statisticss'=>array('db'=>'adv','table'=>'statisticss'),
    'youxiduo_adv_model_statisticssv3'=>array('db'=>'cms','table'=>'appadv_stat'),
    
    /**fujiajun 2015/5/26 添加专题**///
    'youxiduo_topic_model_zt'=>array('db'=>'cms','table'=>'zt'),
    'youxiduo_topic_model_ztgames'=>array('db'=>'cms','table'=>'zt_games'),
    'youxiduo_topic_model_androidgame'=>array('db'=>'cms','table'=>'games_apk'),
    'youxiduo_topic_model_iosgame'=>array('db'=>'cms','table'=>'games'),
    'youxiduo_topic_model_gametype'=>array('db'=>'cms','table'=>'game_type'),
    ...
    'youxiduo_user_model_accountadmin'=>array('db'=>'club','table'=>'account_admin'),
    'youxiduo_user_model_accountcheck'=>array('db'=>'club','table'=>'account_check'),
    'youxiduo_user_model_accountsession'=>array('db'=>'club','table'=>'account_session'),
    'youxiduo_user_model_accountreceiptaddress'=>array('db'=>'club','table'=>'account_receipt_address'),
    //Android
    ...
    'youxiduo_android_model_checkinsmoney'=>array('db'=>'android','table'=>'checkins_money'),
    ...
    'youxiduo_v4_user_model_loginipblacklist'=>array('db'=>'club','table'=>'login_ip_blacklist'),
    'youxiduo_v4_user_model_loginlimit'=>array('db'=>'club','table'=>'login_limit'),
    'youxiduo_v4_user_model_like'=>array('db'=>'club','table'=>'praise'),
    'youxiduo_v4_user_model_money'=>array('db'=>'club','table'=>'credit_account'),
    'youxiduo_v4_user_model_userverifycode'=>array('db'=>'club','table'=>'account_verifycode'),
    'youxiduo_v4_user_model_inviterecord'=>array('db'=>'club','table'=>'tuiguang_account'),
    ...
    'youxiduo_v4_game_model_gameimage'=>array('db'=>'cms','table'=>'games_litpic'),
    'youxiduo_v4_game_model_gamearea'=>array('db'=>'club','table'=>'game_area'),
    'youxiduo_v4_game_model_usergamearea'=>array('db'=>'club','table'=>'account_game_area'),
    //'youxiduo_v4_game_model_gamecircle'=>array('db'=>'club','table'=>'account_circle'), 
    'youxiduo_v4_game_model_gamerecharge'=>array('db'=>'cms','table'=>'games_recharge'), 
    'youxiduo_v4_game_model_gamechannel'=>array('db'=>'club','table'=>'game_channel'),
    ...
    'youxiduo_v4_cms_model_gamevideo'=>array('db'=>'cms','table'=>'games_video'),
    ...
    'youxiduo_android_model_followgame'=>array('db'=>'android','table'=>'follow_game'),
    'youxiduo_android_model_taskblacklist'=>array('db'=>'android','table'=>'task_blacklist'),
    'youxiduo_android_model_activitytasklimit'=>array('db'=>'android','table'=>'activity_task_limit'),
	...
	'youxiduo_cms_model_endyearsummary'=>array('db'=>'cms','table'=>'end_year_summary'),
    'youxiduo_cms_model_videostype'=>array('db'=>'cms','table'=>'videos_type'),
    'youxiduo_game_model_gamesapk'=>array('db'=>'cms','table'=>'games_apk'),
    'youxiduo_game_model_plat360game'=>array('db'=>'cms','table'=>'360plat_game_apk'),   //360平台同步android游戏
    'youxiduo_game_model_plat360log'=>array('db'=>'cms','table'=>'360plat_log'),
    'youxiduo_game_model_plat360synclog'=>array('db'=>'cms','table'=>'360plat_synclog'),
    'youxiduo_game_model_plat360sync'=>array('db'=>'cms','table'=>'360plat_sync'),
